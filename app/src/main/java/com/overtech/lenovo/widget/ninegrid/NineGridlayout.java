package com.overtech.lenovo.widget.ninegrid;
...
public class NineGridlayout extends ViewGroup {
    ...
    private int columns;//
    private int rows;//
    private List<Information.UserImg> listData;
    ...
    public NineGridlayout(Context context, AttributeSet attrs) {
        ...
        totalWidth = screenTools.getScreenWidth() - screenTools.dip2px(116);
    }
    ...
    private void layoutChildrenView() {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            childrenView.setImageUrl(listData.get(i).img);
    ...
    public void setImagesData(List<Information.UserImg> lists) {
