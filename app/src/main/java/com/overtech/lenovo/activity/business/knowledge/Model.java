...
/**
 * Created by Tony1213 on 16/3/24.
 */
public class Model {

    // 第一个listview的图片数据数组
    public static int[] LISTVIEWIMG = new int[]{R.mipmap.ic_category_40,
            R.mipmap.ic_category_10, R.mipmap.ic_category_20,
            R.mipmap.ic_category_30, R.mipmap.ic_category_45,
            R.mipmap.ic_category_50, R.mipmap.ic_category_55,
            R.mipmap.ic_category_60, R.mipmap.ic_category_65,
            R.mipmap.ic_category_70, R.mipmap.ic_category_80,
            R.mipmap.ic_category_85};
